  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20 gap-10">
      <div className="my-10 rounded-lg">
        <h2 className="text-3xl lg:text-6xl sm:text-5xl font-En tracking-tighter bg-gradient-to-l from-green-400 to bg-green-800 text-transparent bg-clip-text  font-semibold text-center ">
          For your pet's health
        </h2>
        <br />
        <h2 className="text-3xl lg:text-6xl sm:text-5xl font-En tracking-tighter bg-gradient-to-r from-green-400 to bg-green-800 text-transparent bg-clip-text  font-semibold text-center ">
          and
        </h2>
        <br />
        <h2 className="text-3xl lg:text-6xl sm:text-5xl font-En tracking-tighter bg-gradient-to-l from-green-400 to bg-green-800 text-transparent bg-clip-text  font-semibold text-center">
      ...
      <p className="w-4/5 text-center text-green-700 max-w-4xl lg:text-lg mb:text-md font-Kr py-20">
        ...
        가고자 합니다. 사랑하는 반려동물의 건강, 저희 병원과 함께 지켜주세요.
        언제든지 문의해 주시면 친절히 안내해 드리겠습니다. 반려동물의 행복이 곧
        우리의 행복입니다.
      </p>
      <img src={dall2} alt="" className="img w-3/4 rounded-lg" />
      <h1 className=" text-green-800 text-4xl font-Kr py-20">
        사랑을 넘은 생명:
        <span className="bg-gradient-to-l from-green-400 to bg-green-800 text-transparent bg-clip-text">
          {' '}
          반려동물과 함께하는 세상
        </span>
      </h1>
